    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #f68b27;">
                <a href="index-php.php" class="buttonVoltar" id="botaoVoltar" target="_top">
                    <img src="/assets/seta-esquerda-removebg-preview-modified.png" alt="Seta Voltar" style="height: 40px; width: 40px; position: relative; left: -280px; top: 12px;">
                </a>
